...
class Respecer:
    ...
    The preferred approach is agent-first (see .claude/agents/respec.md).
    """
    ...
    def respec(
        ...
        Args:
            source_path: Path to the source file to reverse-engineer.
            test_path: Optional path to the test file for additional context.
            model: Optional model override for the LLM provider.

        Returns:
            A spec string in Markdown format with YAML frontmatter.
